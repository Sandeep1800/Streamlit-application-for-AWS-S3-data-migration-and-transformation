...
username = st.text_input("Username",'SANDEEPAPPASANI')
password = st.text_input("Password",'Open@123', type="password")
account = st.text_input("Account Name",'ofb39156.us-east-1')
